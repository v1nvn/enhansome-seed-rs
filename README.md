...
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,241 | 🐛 128 | 🌐 Rust | 📅 2026-03-13 - WASM web application bundler for Rust.
...
* [Pslink](https://pslink.teilgedanken.de) - An URL-shortener page focused on use in publications ([demo](https://demo.pslink.teilgedanken.de/app/) (user, password: demo)).  Uses `Seed`, [`actix-web`](https://actix.rs/), and [`sqlx`](https://github.com/launchbadge/sqlx) ⭐ 16,891 | 🐛 734 | 🌐 Rust | 📅 2026-04-14.
