...
* [Default quickstart](https://github.com/seed-rs/seed-quickstart) ⭐ 99 | 🐛 5 | 🌐 Rust | 📅 2022-09-06 - Contains only Rust libraries.

## Bundlers

* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,298 | 🐛 137 | 🌐 Rust | 📅 2026-03-13 - WASM web application bundler for Rust.
...
* [Pslink](https://pslink.teilgedanken.de) - An URL-shortener page focused on use in publications ([demo](https://demo.pslink.teilgedanken.de/app/) (user, password: demo)).  Uses `Seed`, [`actix-web`](https://actix.rs/), and [`sqlx`](https://github.com/launchbadge/sqlx) ⭐ 17,074 | 🐛 736 | 🌐 Rust | 📅 2026-05-26.
