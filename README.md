...
* ~~Homepage~~
* [GitHub repo](https://github.com/seed-rs/seed) ⭐ 3,831 | 🐛 55 | 🌐 Rust | 📅 2025-01-11
...
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,258 | 🐛 129 | 🌐 Rust | 📅 2026-03-13 - WASM web application bundler for Rust.
...
* [Official examples](https://github.com/seed-rs/seed/tree/master/examples) ⭐ 3,831 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - Smaller examples included in official repo.
...
* [Pslink](https://pslink.teilgedanken.de) - An URL-shortener page focused on use in publications ([demo](https://demo.pslink.teilgedanken.de/app/) (user, password: demo)).  Uses `Seed`, [`actix-web`](https://actix.rs/), and [`sqlx`](https://github.com/launchbadge/sqlx) ⭐ 16,916 | 🐛 740 | 🌐 Rust | 📅 2026-04-23.
