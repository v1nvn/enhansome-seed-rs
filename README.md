...
* ~~Homepage~~
* [GitHub repo](https://github.com/seed-rs/seed) ⭐ 3,836 | 🐛 55 | 🌐 Rust | 📅 2025-01-11
...
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,169 | 🐛 133 | 🌐 Rust | 📅 2026-02-02 - WASM web application bundler for Rust.
...
* [Official examples](https://github.com/seed-rs/seed/tree/master/examples) ⭐ 3,836 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - Smaller examples included in official repo.
...
* [Pslink](https://pslink.teilgedanken.de) - An URL-shortener page focused on use in publications ([demo](https://demo.pslink.teilgedanken.de/app/) (user, password: demo)).  Uses `Seed`, [`actix-web`](https://actix.rs/), and [`sqlx`](https://github.com/launchbadge/sqlx) ⭐ 16,633 | 🐛 731 | 🌐 Rust | 📅 2026-02-12.
...
* [Kavik.cz](https://github.com/MartinKavik/kavik.cz) ⭐ 5 | 🐛 21 | 🌐 Rust | 📅 2026-02-09 - Open-source personal website.
